...
- 🌩️ [Azure Function - API Scraper (Azure Storage, Azure Functions) <- Currently being refactored, check Main for a functional one](https://github.com/endrjuki/AteaHomework/tree/dev)
